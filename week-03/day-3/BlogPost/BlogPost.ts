...
const JohnDoe = new BlogPost('John Doe', 'Lorem Ipsum','Lorem ipsum dolor sit amet.','2000.05.04.')
const Tim = new BlogPost('Tim Urban', 'But Why?','A popular long-form, stick-figure-illustrated blog about almost everything.','2010.10.10.')
const William = new BlogPost('William Turton', 'One Engineer Is Trying to Get IBM to Reckon With Trump',
